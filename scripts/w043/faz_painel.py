...
if MODO == 'detail':
    Y0, X0, ALT, LARG = 3000, 500, 1800, 2200
    SAIDA = f'{D}/panel_w043_detail.png'
    SUB = 'detail crop'
else:
    Y0, X0, ALT, LARG = 0, 0, 6041, 8041
    SAIDA = f'{D}/panel_w043_full.png'
    SUB = 'full segment'

PAINEIS = [
    ('preds_orig_novo.tif',  'original',               "d' 1.605"),
    ('preds_ruido_q8_novo.tif', 'matched noise, MAE 3.5', "d' 1.454   (-9.4%)"),
    ('preds_vc_novo.tif',    'volcomp q8, MAE 3.5',    "d' 1.251   (-22.1%)"),
    ('preds_q16_novo.tif',   'volcomp q16, MAE 6.3',   "d' 0.894   (-44.3%)"),
]
...
fig.suptitle(f'PHerc0139 w043, ink_9um detector - {SUB}', fontsize=13)
